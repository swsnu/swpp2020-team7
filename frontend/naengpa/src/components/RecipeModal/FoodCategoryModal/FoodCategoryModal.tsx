...
const FoodCategoryModal: React.FC<FoodCategoryModalProps> = ({ modifiedCategory, setModifiedCategory, showCategoryModal, setShowCategoryModal, foodCategory, setFoodCategory }) => {
