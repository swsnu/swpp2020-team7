      ...
      <table className="ui definition table create-recipe m-5 d-flex flex-column justify-content-center"> 
       <tbody>
        <tr id="recipe-create-header" className="d-flex justify-contents-center">
          <button id="back-to-recipe-list" onClick={onClickBackToRecipeList}>취소</button>
          <div>레시피 등록</div>
          <button id="add-ingredient" onClick={onClickExtractIngredient}>재료등록</button>
        </tr>
        <tr> 
           요리명
          <textarea id="food-name" onChange={(e) => setFoodName(e.target.value)}></textarea>
        </tr>
        <tr> 
          조리시간
          <textarea id="cook-time" onChange={(e) => setCookTime(e.target.value)}></textarea>
        </tr>
        <tr>
          <PhotoCameraIcon/>
        ...
        <tr>
          레시피           
          <textarea id="recipe" onChange={(e) => setRecipe(e.target.value)}></textarea>
        </tr>
        <tr>#Hash_tag</tr>
        </tbody>
      </table>
