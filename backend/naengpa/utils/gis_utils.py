...
def get_nearest_places_from_region(region_id, topn=50, max_distance=5):
    """
    region_id: id of base region to calculate distances
    topn: max number of regions to return
...
def get_nearest_places_ids_from_lat_lng(lat, lng, topn=50, max_distance=5):
    """
...
def get_nearest_places_names_from_lat_lng(lat, lng, topn=50, max_distance=5):
    """
    lat: latitude of base location to calculate distances
    lng: longitude of base location to calculate distances
    topn: max number of regions to return
...
def get_nearest_places_from_lat_lng(lat, lng, topn=50, max_distance=5):
    """
    lat: latitude of base location to calculate distances
    lng: longitude of base location to calculate distances
    topn: max number of regions to return
